...
// Theme Toggle: Check for saved theme in localStorage and apply it
...
// Add Task: Handle form submission to add a new task
document.getElementById("add-task-btn").addEventListener("click", () => {
  ...
  const categories = categoryInput.value.split(",").map(category => category.trim());
